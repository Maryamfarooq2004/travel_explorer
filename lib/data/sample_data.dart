...
final List<Destination> destinations = [
  ...
  Destination(
    ...
    description: 'Known for its breathtaking mountains and peaceful views. The third largest island in the Trang Sea is Koh Muk, which is beautiful and peaceful like a private island. On the island, there will be villagers living as well, by maintaining a simple way of life.',
  ...
  Destination(
    ...
    name: 'Fairy Meadows',
    location: 'Gilgit-Baltistan, Pakistan',
    description: 'A grassland near one of the base camps of Nanga Parbat. It offers stunning views of the ninth-highest mountain in the world.',
  ...
  Destination(
    ...
    name: 'Skardu',
    location: 'Gilgit-Baltistan, Pakistan',
    description: 'Gateway to some of the highest peaks on Earth, including K2. Home to beautiful lakes and ancient forts.',
    imageUrl: 'https://images.unsplash.com/photo-1570284613060-766c33f6f742?w=800',
    category: 'Mountains',
    rating: 4.7,
    hotels: ['hotel4'],
    restaurants: ['rest4'],
  ...
  Destination(
    ...
    description: 'A beautiful beach with golden sand and blue waves. One of the most popular beaches in Karachi.',
  ...
  Destination(
    ...
    description: 'A pristine beach along the Makran Coastal Highway with stunning sunset views and serene atmosphere.',
  ...
  Destination(
    ...
    description: 'Emerging coastal destination with pristine beaches and unique rock formations.',
  ...
  Destination(
    ...
    description: 'One of the largest mosques in the world, built in 1671 during the Mughal Empire.',
  ...
  Destination(
    ...
    description: 'Ancient Indus Valley civilization site, dating back to 2500 BCE. A UNESCO World Heritage Site.',
  ...
  Destination(
    ...
    name: 'Lahore Fort',
    location: 'Lahore, Punjab, Pakistan',
    description: 'A citadel in the city of Lahore with a history dating back over 1000 years.',
  ...
  Destination(
    ...
    description: 'A mountainous lake located at the northern end of the Kaghan Valley, surrounded by peaks.',
  ...
  Destination(
    ...
    description: 'A stunning turquoise lake formed in 2010 after a massive landslide. Perfect for boating.',
...
final List<Hotel> hotels = [
  Hotel(
    ...
    description: 'Luxury hotel with stunning mountain views and modern amenities.',
  ),
  Hotel(
    id: 'hotel2',
    name: 'Luxus Hunza',
  ...
  Hotel(
    ...
    rating: 4.7,
    imageUrl: 'https://images.unsplash.com/photo-1569670517782-46b1e5c96e73?w=800',
    price: 'PKR 22,000/night',
    description: 'Luxury hotel in the heart of Lahore, near all major attractions.',
  ),
];
